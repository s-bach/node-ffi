...
function CIF_var (rtype, types, numFixedArgs, abi, setLastError) {
  ...
  var status = ffi_prep_cif_var(cif, numFixedArgs, numTotalArgs, _rtypeptr, _argtypesptr, abi, setLastError)
